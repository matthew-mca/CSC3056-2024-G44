    ...
    public void testCalculateRowTotalWithNull() {
		try {
	        ...
	        if (e instanceof IllegalArgumentException) {
	            ...
	            fail("NullPointerException was not expected: " + e.getMessage());
	        } else {
	            // Fail the test for any other types of exceptions
	            fail("An unexpected exception was thrown: " + e.getClass().getName() + " with message: " + e.getMessage());
	        }
	    }
	}
